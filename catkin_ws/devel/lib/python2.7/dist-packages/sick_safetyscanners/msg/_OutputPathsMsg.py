...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.is_safe))
      length = len(self.is_valid)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.is_valid))
      buff.write(_get_struct_i().pack(self.active_monitoring_case))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.status = map(bool, self.status)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.is_safe = struct.unpack(pattern, str[start:end])
      self.is_safe = map(bool, self.is_safe)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.is_valid = struct.unpack(pattern, str[start:end])
      self.is_valid = map(bool, self.is_valid)
      start = end
      end += 4
