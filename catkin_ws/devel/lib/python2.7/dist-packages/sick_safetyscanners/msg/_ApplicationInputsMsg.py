...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.unsafe_inputs_input_sources))
      length = len(self.unsafe_inputs_flags)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.unsafe_inputs_flags))
      length = len(self.monitoring_case_number_inputs)
      buff.write(_struct_I.pack(length))
      pattern = '<%sH'%length
      buff.write(struct.pack(pattern, *self.monitoring_case_number_inputs))
      length = len(self.monitoring_case_number_inputs_flags)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.monitoring_case_number_inputs_flags))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.unsafe_inputs_input_sources = struct.unpack(pattern, str[start:end])
      self.unsafe_inputs_input_sources = map(bool, self.unsafe_inputs_input_sources)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.unsafe_inputs_flags = struct.unpack(pattern, str[start:end])
      self.unsafe_inputs_flags = map(bool, self.unsafe_inputs_flags)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sH'%length
      ...
      self.monitoring_case_number_inputs = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.monitoring_case_number_inputs_flags = struct.unpack(pattern, str[start:end])
      self.monitoring_case_number_inputs_flags = map(bool, self.monitoring_case_number_inputs_flags)
      _x = self
      start = end
      end += 9
