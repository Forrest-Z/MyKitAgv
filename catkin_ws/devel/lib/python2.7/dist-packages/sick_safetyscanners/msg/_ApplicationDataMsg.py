...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.inputs.unsafe_inputs_input_sources))
      length = len(self.inputs.unsafe_inputs_flags)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.inputs.unsafe_inputs_flags))
      length = len(self.inputs.monitoring_case_number_inputs)
      buff.write(_struct_I.pack(length))
      pattern = '<%sH'%length
      buff.write(struct.pack(pattern, *self.inputs.monitoring_case_number_inputs))
      length = len(self.inputs.monitoring_case_number_inputs_flags)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.inputs.monitoring_case_number_inputs_flags))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.outputs.evaluation_path_outputs_eval_out))
      length = len(self.outputs.evaluation_path_outputs_is_safe)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.outputs.evaluation_path_outputs_is_safe))
      length = len(self.outputs.evaluation_path_outputs_is_valid)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.outputs.evaluation_path_outputs_is_valid))
      length = len(self.outputs.monitoring_case_number_outputs)
      buff.write(_struct_I.pack(length))
      pattern = '<%sH'%length
      buff.write(struct.pack(pattern, *self.outputs.monitoring_case_number_outputs))
      length = len(self.outputs.monitoring_case_number_outputs_flags)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.outputs.monitoring_case_number_outputs_flags))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sh'%length
      buff.write(struct.pack(pattern, *self.outputs.resulting_velocity))
      length = len(self.outputs.resulting_velocity_flags)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.outputs.resulting_velocity_flags))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.inputs.unsafe_inputs_input_sources = struct.unpack(pattern, str[start:end])
      self.inputs.unsafe_inputs_input_sources = map(bool, self.inputs.unsafe_inputs_input_sources)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.inputs.unsafe_inputs_flags = struct.unpack(pattern, str[start:end])
      self.inputs.unsafe_inputs_flags = map(bool, self.inputs.unsafe_inputs_flags)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sH'%length
      ...
      self.inputs.monitoring_case_number_inputs = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.inputs.monitoring_case_number_inputs_flags = struct.unpack(pattern, str[start:end])
      self.inputs.monitoring_case_number_inputs_flags = map(bool, self.inputs.monitoring_case_number_inputs_flags)
      _x = self
      start = end
      end += 9
      ...
      self.outputs.evaluation_path_outputs_eval_out = struct.unpack(pattern, str[start:end])
      self.outputs.evaluation_path_outputs_eval_out = map(bool, self.outputs.evaluation_path_outputs_eval_out)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.outputs.evaluation_path_outputs_is_safe = struct.unpack(pattern, str[start:end])
      self.outputs.evaluation_path_outputs_is_safe = map(bool, self.outputs.evaluation_path_outputs_is_safe)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.outputs.evaluation_path_outputs_is_valid = struct.unpack(pattern, str[start:end])
      self.outputs.evaluation_path_outputs_is_valid = map(bool, self.outputs.evaluation_path_outputs_is_valid)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sH'%length
      ...
      self.outputs.monitoring_case_number_outputs = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.outputs.monitoring_case_number_outputs_flags = struct.unpack(pattern, str[start:end])
      self.outputs.monitoring_case_number_outputs_flags = map(bool, self.outputs.monitoring_case_number_outputs_flags)
      _x = self
      start = end
      end += 17
      ...
      self.outputs.resulting_velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.outputs.resulting_velocity_flags = struct.unpack(pattern, str[start:end])
      self.outputs.resulting_velocity_flags = map(bool, self.outputs.resulting_velocity_flags)
      return self
