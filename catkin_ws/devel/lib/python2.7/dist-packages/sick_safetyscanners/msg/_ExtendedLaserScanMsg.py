...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.reflektor_status))
      length = len(self.reflektor_median)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.reflektor_median))
      length = len(self.intrusion)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.intrusion))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.reflektor_status = struct.unpack(pattern, str[start:end])
      self.reflektor_status = map(bool, self.reflektor_status)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.reflektor_median = struct.unpack(pattern, str[start:end])
      self.reflektor_median = map(bool, self.reflektor_median)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.intrusion = struct.unpack(pattern, str[start:end])
      self.intrusion = map(bool, self.intrusion)
      return self
