...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.evaluation_path_outputs_eval_out))
      length = len(self.evaluation_path_outputs_is_safe)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.evaluation_path_outputs_is_safe))
      length = len(self.evaluation_path_outputs_is_valid)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.evaluation_path_outputs_is_valid))
      length = len(self.monitoring_case_number_outputs)
      buff.write(_struct_I.pack(length))
      pattern = '<%sH'%length
      buff.write(struct.pack(pattern, *self.monitoring_case_number_outputs))
      length = len(self.monitoring_case_number_outputs_flags)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.monitoring_case_number_outputs_flags))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sh'%length
      buff.write(struct.pack(pattern, *self.resulting_velocity))
      length = len(self.resulting_velocity_flags)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.resulting_velocity_flags))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.evaluation_path_outputs_eval_out = struct.unpack(pattern, str[start:end])
      self.evaluation_path_outputs_eval_out = map(bool, self.evaluation_path_outputs_eval_out)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.evaluation_path_outputs_is_safe = struct.unpack(pattern, str[start:end])
      self.evaluation_path_outputs_is_safe = map(bool, self.evaluation_path_outputs_is_safe)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.evaluation_path_outputs_is_valid = struct.unpack(pattern, str[start:end])
      self.evaluation_path_outputs_is_valid = map(bool, self.evaluation_path_outputs_is_valid)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sH'%length
      ...
      self.monitoring_case_number_outputs = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.monitoring_case_number_outputs_flags = struct.unpack(pattern, str[start:end])
      self.monitoring_case_number_outputs_flags = map(bool, self.monitoring_case_number_outputs_flags)
      _x = self
      start = end
      end += 17
      ...
      self.resulting_velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.resulting_velocity_flags = struct.unpack(pattern, str[start:end])
      self.resulting_velocity_flags = map(bool, self.resulting_velocity_flags)
      return self
